...
@Component({
  selector: 'tg-slot-quiz',
  templateUrl: './slot-quiz.component.html',
  styleUrls: ['./slot-quiz.component.css'],
  providers: [ ParticipantService ]
})

export class SlotQuizComponent {
  ...
  constructor(private router: Router,
              ...
              private http: Http) {
    this.http.get('/assets/slot_attention_check.json')
            .subscribe(res => {
              this.questions = res.json();
            });
    this.http.get('/assets/slot_attention_check_feedback.json')
            .subscribe(res => {
